...
class ProcessObs:
    ...
    def SaveFigureAsImage(self, fileName, fig=None, **kwargs):
        ...
        a.set_xticks([]);
        a.set_yticks([])
        fig.savefig(fileName, transparent=True, bbox_inches='tight', pad_inches=0, dpi=30)
            ...
            if True:
                ...
                if len(loc_obs_temp) > 1:
                    ...
                    try:
                        ...
                        print "Saving"
                        fig.savefig(root_folder + date_path + "\Observations\\" + k + "-" + graph_type + "-" + time_now + ".png", dpi=dpi_int, )
                        fig.clf()
                    except IndexError:
                        pass
