...
root_folder = "C:\Users\Nathan\Documents\Storm Chasing"
...
for i in range(0, len(incidents_lists)):
    ...
    points_list.append(incident_folder.newpoint(name=str(current_incident.get_id())))
...
for i in range(0, len(incidents_lists)):
    ...
    points_list2.append(incident_folder2.newpoint(name=str(current_incident.get_id())))
...
live_save = root_folder + "\Incidents Backup\Live-Incidents.kml"
backup_save = root_folder + "\Incidents Backup\Incidents " + formatted_time + ".kml"
